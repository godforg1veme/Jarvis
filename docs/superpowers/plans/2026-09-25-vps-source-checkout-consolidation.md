...
- [x] **Step 1: Write failing tests using temporary local Git repositories**
...
- [x] **Step 2: Implement the guard with closed modes and safe output**
...
- [x] **Step 1: Add ordering assertions**
...
- [x] **Step 2: Wire preflight into deployment entrypoints**
...
- [x] **Step 3: Run deployment-script and guard tests**
...
- [x] **Step 4: Commit the deployment gate**
...
- [x] **Step 1: Add the concise canonical-source rule to `AGENTS.md`**
...
- [x] **Step 2: Update the operator runbook in plain, direct language**
...
- [x] **Step 3: Mark the approved spec status and review documentation consistency**
...
- [x] **Step 4: Run text and whitespace checks, then commit**
...
- [x] **Step 1: Run the complete Host Agent suite and review branch history**
...
- [x] **Step 2: Fast-forward local `main`, publish, and confirm GitHub state**
...
- [x] **Step 3: Verify preflight on the Windows checkout**
...
- [x] **Step 1: Reconfirm GitHub target and capture read-only host/service baselines**
...
- [x] **Step 2: Inventory operational state and compare checksums**
...
- [x] **Step 3: Clone current `main` into a fresh sibling staging directory on both VPSs**
...
- [x] **Step 4: Restore required operational files into staging and verify manifests**
...
- [x] **Step 5: Prove primary Compose parity before promotion**
...
- [x] **Step 1: Promote the secondary VPN/Host Agent node**
...
- [x] **Step 2: Promote the primary Jarvis node**
...
- [x] **Step 3: Verify both VPSs and public readiness**
...
- [x] **Step 4: Release temporary rollback copies only after checks pass**
...
- [x] **Step 5: Record completion and close the task branch**
