...
- первый сквозной контур Jarvis Vision: явный локальный Vision Lease, камера через
  ...
  Два физических монитора и полный тестовый контур проверены 2026-09-09; живая
  live Camo-захват 1280×720 проверен 2026-09-09; production-развёртывание
...
- PWA и расширение Vision после первого вертикального среза: production provider acceptance,
  production rollout провайдера, временные события и более широкая multi-device UX.
