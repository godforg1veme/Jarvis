...
- первый сквозной контур Jarvis Vision: явный локальный Vision Lease, камера через
  ...
  Camo-камера и production-развёртывание vision-провайдера ещё требуют acceptance.
...
- PWA и расширение Vision после первого вертикального среза: live Camo acceptance,
