...
The only remaining manual acceptance is importing the delivered text file or QR
code into the user's actual Happ application and checking the target networks
from the intended device/carrier.
